      ...
      <header class="navbar navbar-expand-md navbar-light d-print-none">
        <div class="container-xl">
          ...
          <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href=".">
              <img src="./assets/logo.svg" width="110" height="32" alt="Tabler" class="navbar-brand-image">
            </a>
          </h1>
            ...
            <div v-if="auth.profile" class="nav-item dropdown">
              <a class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                ...
                <div class="d-none d-xl-block ps-2">
                  ...
                  <div class="mt-1 small text-muted">{{ this.auth.profile.email }}</div>
                </div>
              </a>
              <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                ...
                <a id="text-button" v-if="this.auth.authenticated" @click.prevent="logOut" class="dropdown-item">Log out</a>
          ...
          <div class="collapse navbar-collapse" id="navbar-menu">
            <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <router-link v-if="this.auth.authenticated" :to="{ name: 'employee.index' }" class="nav-link">
                    <span class="nav-link-icon d-md-none d-lg-inline-block">
