...
<script>
// TODO: this click func not working
...
//     onMounted(() => {
//       if(theme == 'light'){
//         console.log("mounted in the composition api!",theme);
//       }else{
...
//     function setTheme() {
//       if(this.theme == 'light'){
//         console.log("clicked in the composition api!",this.theme);
//       }else{
//         console.log("clicked in the composition api!");
//       }      
//     }
//        return { setTheme } 
//    }
